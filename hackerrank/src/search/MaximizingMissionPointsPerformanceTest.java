...
public class MaximizingMissionPointsPerformanceTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            dLat = 43000;
            dLong = 30000;
            List<City> cities = generateCities(n, 220000, 220000, 400000);
            ...
            Date d2 = new Date();
            System.out.println("Fill levels took - " + (d2.getTime() - d1.getTime()) + "ms");
            ...
            for (City city : cities) {
                ...
                Date l2 = new Date();
                latProcess += l2.getTime() - l1.getTime();
                ...
                updateTrees += u2.getTime() - u1.getTime();
            }

            System.out.println("processLat took - " + latProcess + "ms");
            System.out.println("updateTrees took - " + updateTrees + "ms");
            ...
            /*if (latSegments[1].segmentTree[1] != calcTrivial(cities)) {
